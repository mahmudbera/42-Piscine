...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/28 12:56:18 by makarago          #+#    #+#             */
/*   Updated: 2024/01/28 17:09:30 by makarago         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rush(int col, int row)
{
	...
	while (row_c <= row)
	{
		...
		while (c_c <= col)
		{
			if ((row_c == 1 && c_c == 1) || (row_c == 1 && c_c == col))
				ft_putchar('A');
			else if ((row_c == row && c_c == 1) || (row_c == row && c_c == col))
				ft_putchar('C');
